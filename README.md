## 📝✨ **remark-shiki-twoslash (fork) – Updated with the latest Shiki!** 🚀  

This is a fork of [remark-shiki-twoslash](https://github.com/shikijs/twoslash/tree/main/packages/remark-shiki-twoslash) with an updated **Shiki** version for better syntax highlighting and performance. 🎨⚡  

🔹 **What's new?**  
- 🚀 **Updated Shiki** to the latest version for improved highlighting ✨  
<!-- - 🛠 Bug fixes and compatibility improvements -->  
- 🔧 Actively maintained to keep up with new Shiki releases  

Original project by [twoslashes](https://github.com/twoslashes). This fork ensures you get the latest and greatest Shiki experience! 🎯  

📦 Available on npm: `@HidemaruOwO/remark-shiki-twoslash`

```bash
pnpm add @HidemaruOwO/remark-shiki-twoslash
```

> [!NOTE]  
> **Found an issue?** 🐛  
> Please open an [issue](https://github.com/HidemaruOwO/remark-shiki-twoslash/issues) or contact us at [hide0.net/contact](https://hide0.net/contact).  
